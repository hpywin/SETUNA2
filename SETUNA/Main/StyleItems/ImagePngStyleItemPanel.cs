        ...
        protected override void OKCheck(ref bool cancel)
        {
            ...
            if (txtFolder.Text != "")
            {
                ...
                catch
                {
                    ...
                    MessageBox.Show(Properties.Resources.label71, Application.ProductName, MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                    txtFolder.Focus();
                    return;
                }
            }
            if (!rdoSaveAs.Checked && rdoName.Checked)
            {
                if (txtName.Text == "")
                {
                    ...
                    MessageBox.Show(Properties.Resources.label72, Application.ProductName, MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                    txtName.Focus();
                    return;
                }
                ...
                foreach (var value in invalidFileNameChars)
                {
                    if (txtName.Text.IndexOf(value) > -1)
                    {
                        ...
                        MessageBox.Show(Properties.Resources.label73, Application.ProductName, MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                        txtName.Focus();
                        return;
                    }
                }
